...
self.addEventListener('notificationclick', function (event) {
  ...
  const taskId = (_event$notification$d = event.notification.data) === null || _event$notification$d === void 0 ? void 0 : _event$notification$d.taskId;
          ...
          logsStore.getAll().onsuccess = async logsReq => {
            ...
            for (const task of tasks) {
              ...
              if (isTimeReached) {
                ...
                const alreadyShowing = activeNotes.some(n => {
                  var _n$data;
                  return ((_n$data = n.data) === null || _n$data === void 0 ? void 0 : _n$data.taskId) === task.id;
                });
                if (!hasLogToday && !alreadyShowing) {
                  ...
                  }).then(() => console.log('Sucesso!')).catch(err => console.error("Falhou ao disparar showNotification:", err));
                } else {
